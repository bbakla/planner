					...
					<div class="panel-body">
						<form:form method="POST" modelAttribute="parent">
							<div class="form-group">
								<label for="title" class="col-2 col-form-label">Enter
									your daily goal </label>
						...
						<br />
						<br /> <a href="<c:url value='/planner/plan/week'/>"
							class="btn btn-primary btn-lg btn-block">Create your weekly
							plan</a>
					</div>
				</div>
			</div>
